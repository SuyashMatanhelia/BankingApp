...
type Customer struct {
	...
	ContactNumber int       `json:"contact_number" sql:"contact_number,type:numeric(10) NOT NULL"`
	...
	FkBankId      int       `json:"fk_bank_id" sql:"fk_bank_id, type:bigint REFERENCES bank(bank_id) "`
